        ...
        try (Connection conn = DatabaseConnection.getConnection()) {
            ...
            if (rs.next()) {
                ...
                if ("Admins".equalsIgnoreCase(role)) {
                    ...
                    JOptionPane.showMessageDialog(this, "Anda tidak memiliki izin untuk login sebagai Admin!", "Error", JOptionPane.ERROR_MESSAGE);
                }
            } else {
        ...
        try (Connection conn = DatabaseConnection.getConnection()) {
            ...
            if (rs.next()) {
                ...
                if ("Receptionist".equalsIgnoreCase(role)) {
                    JOptionPane.showMessageDialog(this, "Login berhasil sebagai Receptionist!");
                    new Receptionist().setVisible(true);
                    this.dispose();
                } else {
                    JOptionPane.showMessageDialog(this, "Anda tidak memiliki izin untuk login sebagai Receptionist!", "Error", JOptionPane.ERROR_MESSAGE);
                }
            } else {
                JOptionPane.showMessageDialog(this, "Username atau Password salah!", "Error", JOptionPane.ERROR_MESSAGE);
            }
